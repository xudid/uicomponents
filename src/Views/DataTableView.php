...
class DataTableView extends ViewFactory
{
    ...
    {
        $this->drt = new ModelTableFactory($this->legends,
            $this->columns,
            $this->data,
            $this->rowsclickable,
            $this->baseurl);
    ...
    public function getView($app)
    {
        ...
        if ($columns) {
            ...
            $this->drt = new ModelTableFactory($this->legends, $columns, $rows, $this->rowsclickable, $this->baseurl);
